...
enum class AppIcon(@DrawableRes val drawableRes: Int, val contentDescription: String) {
    ...
    CoffeePlus(R.drawable.fa_coffee_plus, "Add coffee"),
    CoffeeAeropress(R.drawable.fa_coffee_aeropress, "Aeropress"),
    CoffeeAeropressFilled(R.drawable.fa_coffee_aeropress_filled, "Aeropress"),
    CoffeeChemex(R.drawable.fa_coffee_chemex, "Chemex"),
    CoffeeChemexFilled(R.drawable.fa_coffee_chemex_filled, "Chemex"),
    CoffeePot(R.drawable.fa_coffee_pot, "Coffee pot"),
    CoffeePotFilled(R.drawable.fa_coffee_pot_filled, "Coffee pot"),
    CoffeeTogo(R.drawable.fa_coffee_togo, "Coffee to go"),
    CoffeeTogoFilled(R.drawable.fa_coffee_togo_filled, "Coffee to go"),
    CoffeeBean(R.drawable.fa_coffee_bean, "Coffee bean"),
    CoffeeBeanFilled(R.drawable.fa_coffee_bean_filled, "Coffee bean"),
    CoffeeBeans(R.drawable.fa_coffee_beans, "Coffee beans"),
    CoffeeBeansFilled(R.drawable.fa_coffee_beans_filled, "Coffee beans"),
    Sparkles(R.drawable.fa_sparkles, "Sparkles"),
    Location(R.drawable.fa_location, "Location"),
    Ratio(R.drawable.fa_ratio, "Ratio"),
    Temperature(R.drawable.fa_temperature, "Temperature"),
    ...
    Store(R.drawable.fa_store, "Store"),
    StoreFilled(R.drawable.fa_store_filled, "Store"),
    StorePlus(R.drawable.fa_store_plus, "Add store"),
    StorePlusFilled(R.drawable.fa_store_plus_filled, "Add store"),
    CoffeeBeanPlus(R.drawable.fa_coffee_bean_plus, "Add coffee bean"),
    CoffeeBeanPlusFilled(R.drawable.fa_coffee_bean_plus_filled, "Add coffee bean"),
